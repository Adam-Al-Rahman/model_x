"""Provides the repository macro to import Libtorch. Module extension for "configuring" libtorch_bazel."""
...
_INTEGRITIES = {
    ...
    "2.8.0": {
        "linux": "sha256-9uhScchZT3QHBVF/IxXvNYzQ2TR9fJLi2lHcsYUPx2M=",
...
_URLS = {
    "2.8.0": {
        "linux": "https://download.pytorch.org/libtorch/cu129/libtorch-shared-with-deps-2.8.0%2Bcu129.zip",
        "macos": "https://download.pytorch.org/libtorch/cpu/libtorch-macos-arm64-2.8.0.zip",
    },
}

def _libtorch_configure_extension_impl(module_ctx):
    version = "2.8.0"  # default version
